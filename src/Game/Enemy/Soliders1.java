...
public class Soliders1 extends BaseEnemy {
    protected int waypoint = 0;
    protected Direction direction;

    public Soliders1 (int k , int pos_x , int pos_y){
        this.pos_x = pos_x;
        this.pos_y = pos_y;
        int x = k;
        speed = 1;
    ...
    public final Point[] wayPoint2 = new Point[]{
            new Point( 4*64 + 32 , -32*4),
            new Point( 4*64 + 32 , -32*3),
            new Point( 4*64 + 32 , -32*2),
            new Point( 4*64 + 32 , -32),
